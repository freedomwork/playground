...
namespace VipSoft.BLL
{
	...
	{
		private readonly VipSoft.DAL.ActivityRule dal=new VipSoft.DAL.ActivityRule();
		public ActivityRule()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<VipSoft.Model.ActivityRule> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<VipSoft.Model.ActivityRule> DataTableToList(DataTable dt)
		{
			List<VipSoft.Model.ActivityRule> modelList = new List<VipSoft.Model.ActivityRule>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				VipSoft.Model.ActivityRule model;
