...
namespace VipSoft.BLL
{
	...
	{
		private readonly VipSoft.DAL.OrderGoods dal=new VipSoft.DAL.OrderGoods();
		public OrderGoods()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<VipSoft.Model.OrderGoods> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<VipSoft.Model.OrderGoods> DataTableToList(DataTable dt)
		{
			List<VipSoft.Model.OrderGoods> modelList = new List<VipSoft.Model.OrderGoods>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				VipSoft.Model.OrderGoods model;
