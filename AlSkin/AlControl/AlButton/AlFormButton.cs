...
namespace AlSkin.AlControl
{
    ...
    public class AlFormButton : Button
    {
        #region 声明
        private State state = State.Normal;
        public Bitmap _BackImg = AlSkin.Properties.Resources.AlButton; //ImageObject.GetResBitmap("AlSkin.AlSkinImg.AlButtonImg.Bottom2.png");
        ...
        [CategoryAttribute("阿龙自定义属性"), Description("显示字体颜色")]
