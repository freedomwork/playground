...
{
    public class AlToolStripRenderer : ToolStripRenderer
    {
        private int i;
        Bitmap backImg = AlSkin.Properties.Resources.AlToolstrip; //ImageObject.GetResBitmap("AlSkin.AlControl.AlToolStrip.Toolstrip.png");

        public AlToolStripRenderer()
        {
        }
