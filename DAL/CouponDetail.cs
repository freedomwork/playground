...
namespace VipSoft.DAL
{
	...
	public partial class CouponDetail
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "CouponDetail"); 
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(VipSoft.Model.CouponDetail model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CouponDetail set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CouponDetail ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.CouponDetail GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,CouponID,CouponNumber,State,UsedTime from CouponDetail ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			VipSoft.Model.CouponDetail model=new VipSoft.Model.CouponDetail();
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.CouponDetail DataRowToModel(DataRow row)
		{
			VipSoft.Model.CouponDetail model=new VipSoft.Model.CouponDetail();
			if (row != null)
			{
				...
				if(row["UsedTime"]!=null && row["UsedTime"].ToString()!="")
				{
					model.UsedTime=DateTime.Parse(row["UsedTime"].ToString());
				}
			}
			return model;
		}
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,CouponID,CouponNumber,State,UsedTime ");
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CouponDetail T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CouponDetail";
