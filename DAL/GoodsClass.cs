...
namespace VipSoft.DAL
{
	...
	public partial class GoodsClass
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "GoodsClass"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ClassName,ParentID,ShopID,ShopName ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,ClassName,ParentID,ShopID,ShopName ");
			strSql.Append(" FROM GoodsClass ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
