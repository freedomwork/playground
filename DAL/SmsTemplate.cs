...
namespace VipSoft.DAL
{
	...
	public partial class SmsTemplate
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "SmsTemplate"); 
		}
		...
		public VipSoft.Model.SmsTemplate GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,TemplateName,TemplateContent from SmsTemplate ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			VipSoft.Model.SmsTemplate model=new VipSoft.Model.SmsTemplate();
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.SmsTemplate DataRowToModel(DataRow row)
		{
			VipSoft.Model.SmsTemplate model=new VipSoft.Model.SmsTemplate();
			if (row != null)
			{
				...
				if(row["TemplateContent"]!=null)
				{
					model.TemplateContent=row["TemplateContent"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,TemplateName,TemplateContent ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,TemplateName,TemplateContent ");
			strSql.Append(" FROM SmsTemplate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
