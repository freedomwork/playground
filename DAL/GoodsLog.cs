...
namespace VipSoft.DAL
{
	...
	public partial class GoodsLog
	{
		...
		public VipSoft.Model.GoodsLog GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,GoodsID,Type,Number,MasterID,MasterName,CreateDateTime,Remark from GoodsLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			VipSoft.Model.GoodsLog model=new VipSoft.Model.GoodsLog();
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.GoodsLog DataRowToModel(DataRow row)
		{
			VipSoft.Model.GoodsLog model=new VipSoft.Model.GoodsLog();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,GoodsID,Type,Number,MasterID,MasterName,CreateDateTime,Remark ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,GoodsID,Type,Number,MasterID,MasterName,CreateDateTime,Remark ");
			strSql.Append(" FROM GoodsLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
