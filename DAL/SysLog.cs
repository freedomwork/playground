...
namespace VipSoft.DAL
{
	...
	public partial class SysLog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "SysLog"); 
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(VipSoft.Model.SysLog model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SysLog set ");
			strSql.Append("MasterAccount=@MasterAccount,");
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.SysLog GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,MasterAccount,MasterName,Area,Detail,CreateDateTime,ShopID,ShopName from SysLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			VipSoft.Model.SysLog model=new VipSoft.Model.SysLog();
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.SysLog DataRowToModel(DataRow row)
		{
			VipSoft.Model.SysLog model=new VipSoft.Model.SysLog();
			if (row != null)
			{
				...
				if(row["MasterAccount"]!=null)
				{
					model.MasterAccount=row["MasterAccount"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,MasterAccount,MasterName,Area,Detail,CreateDateTime,ShopID,ShopName ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,MasterAccount,MasterName,Area,Detail,CreateDateTime,ShopID,ShopName ");
			strSql.Append(" FROM SysLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
