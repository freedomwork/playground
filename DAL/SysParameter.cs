...
namespace VipSoft.DAL
{
	...
	public partial class SysParameter
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "SysParameter"); 
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(VipSoft.Model.SysParameter model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			parameters[4].Value = model.GroupTitle;
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.SysParameter GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,KeyName,Title,Type,MaxLength,GroupTitle,Value,Description from SysParameter ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)			};
			parameters[0].Value = ID;

			VipSoft.Model.SysParameter model=new VipSoft.Model.SysParameter();
		...
		/// 得到一个对象实体
		/// </summary>
		public VipSoft.Model.SysParameter DataRowToModel(DataRow row)
		{
			VipSoft.Model.SysParameter model=new VipSoft.Model.SysParameter();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,KeyName,Title,Type,MaxLength,GroupTitle,Value,Description ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SysParameter";
